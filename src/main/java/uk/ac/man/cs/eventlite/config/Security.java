...
public class Security extends WebSecurityConfigurerAdapter {
	...
	private static final RequestMatcher[] NO_AUTH = { new AntPathRequestMatcher("/webjars/**", "GET"),
			...
			new AntPathRequestMatcher("/events", "GET"), new AntPathRequestMatcher("/events/{id:[\\d]+}", "GET"),
			new AntPathRequestMatcher("/venues", "GET"), new AntPathRequestMatcher("/venues/{id:[\\d]+}", "GET")};
