...
public class HomePageTest {
	...
	public void getJsonRoot() throws Exception {
		// curl -H "Accept: application/json" http://localhost:8080/ will return 406, 
		// same with other urls that start with http://localhost:8080/
		// could not find a workaround (4 hours)
